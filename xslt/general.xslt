					...
					<tbody>
						<tr align="left">
							<td id="notesTableTd" height="100">
								...
								<xsl:if
									test="//n1:Invoice/cbc:InvoiceTypeCode='IHRACKAYITLI' and //n1:Invoice/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReasonCode = '702' and //n1:Invoice/cac:AdditionalDocumentReference/cbc:DocumentType[text()='KARSIBELGENO']">
									<b>&#160;&#160;&#160;&#160;&#160; Karşı Belge No: </b>
									<xsl:value-of
